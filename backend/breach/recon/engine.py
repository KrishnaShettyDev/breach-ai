...
from backend.breach.core.memory import AttackSurface, Finding, Severity, Endpoint
...
from backend.breach.utils.helpers import extract_domain, normalize_url
    ...
    async def _fingerprint_technologies(self, target_url: str, result: ReconResult):
        ...
        try:
            ...
            if response.is_success:
                ...
                from backend.breach.utils.helpers import detect_technology
