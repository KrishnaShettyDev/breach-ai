...
from backend.breach.attacks.nosql import NoSQLInjectionAttack
from backend.breach.attacks.xss import XSSAttack
from backend.breach.attacks.ssrf import SSRFAttack
from backend.breach.attacks.injection import CommandInjectionAttack, SSTIAttack, XXEAttack
...
from backend.breach.attacks.business_logic_destroyer import BusinessLogicDestroyer
from backend.breach.attacks.client_side_carnage import ClientSideCarnage
from backend.breach.attacks.modern_stack_destroyer import ModernStackDestroyer
from backend.breach.attacks.cloud_destroyer import CloudDestroyer
from backend.breach.attacks.docker_destroyer import DockerDestroyer
from backend.breach.attacks.file_warfare import FileWarfare
...
from backend.breach.attacks.injection_arsenal import InjectionArsenal
from backend.breach.attacks.living_off_the_land import LivingOffTheLand
from backend.breach.attacks.base import AttackResult

# V1 Recon Modules
from backend.breach.recon.dns import DNSEnumerator
from backend.breach.recon.ports import PortScanner
from backend.breach.recon.web import WebCrawler, CrawlResult
from backend.breach.recon.recon_warfare import ReconWarfare
from backend.breach.recon.social_engineering import SocialEngineering

# HTTP Client
from backend.breach.utils.http import HTTPClient

# Fix Recommendations Database
from backend.breach.recommendations import get_recommendation, ALL_RECOMMENDATIONS
