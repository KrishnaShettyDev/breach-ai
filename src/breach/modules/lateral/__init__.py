...
from breach.modules.lateral.network_spider import NetworkSpider
from breach.modules.lateral.credential_harvester import CredentialHarvester
from breach.modules.lateral.cloud_hopper import CloudHopper
